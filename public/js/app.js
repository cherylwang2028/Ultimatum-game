...
function cancelReconnectAndLeave() {
...
function handleMessage(msg) {
  switch (msg.type) {
    ...
    case 'error':
      ...
      if (!$('reconnect-overlay').classList.contains('hidden')) {
        cancelReconnectAndLeave();
      }
      break;
  }
...
$('btn-cancel-reconnect').addEventListener('click', cancelReconnectAndLeave);
$('btn-cancel-reconnect-text').addEventListener('click', cancelReconnectAndLeave);
